...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        \DB::table('accommodation_types')->insert([
            ...
            ['slug' => 'camper', 'name' => json_encode(['en' => 'Camper/RV']), 'description' => json_encode(['en' => 'A mobile accommodation unit with sleeping, cooking, and bathroom facilities for road trips.']), 'icon' => 'Camper', 'order' => 24, 'is_active' => true],
            ['slug' => 'tiny-house', 'name' => json_encode(['en' => 'Tiny house']), 'description' => json_encode(['en' => 'A compact, efficiently designed home offering minimalist living in a small footprint.']), 'icon' => 'Tinyhouse', 'order' => 25, 'is_active' => true],
            ...
            ['slug' => 'earth-house', 'name' => json_encode(['en' => 'Earth house']), 'description' => json_encode(['en' => 'A partially underground dwelling built into hillsides, offering sustainable living.']), 'icon' => 'EarthHouse', 'order' => 36, 'is_active' => true],
            ['slug' => 'cycladic', 'name' => json_encode(['en' => 'Cycladic home']), 'description' => json_encode(['en' => 'A traditional whitewashed Greek island home with blue accents and cubic architecture.']), 'icon' => 'Cycladic', 'order' => 37, 'is_active' => true],
