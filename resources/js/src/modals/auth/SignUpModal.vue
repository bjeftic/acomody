        ...
        >
            <n-form-item path="email" label="Email address">
                <n-input
                    ...
                    :status="signUpErrors && signUpErrors.email ? 'error' : ''"
            ...
            <n-form-item path="password" label="Password">
                <n-input
                    ...
                    :status="
                        signUpErrors && signUpErrors.password ? 'error' : ''
                    "
                    @keypress.enter="handleSignUp"
                />
            </n-form-item>
            ...
            <div class="font-semibold text-sm my-4">
                By creating an account, you're agreeing with our Terms of Use
                and Privacy Policy
            </div>
...
import { toCamelCase, handle422ValidationErrors } from "@/utils/helpers";
...
export default {
    ...
    methods: {
        ...mapActions(["initModal", "closeModal", "signUp", "logIn"]),
        async handleSignUp() {
