            ...
            >
                ...
                <div class="p-6">
                    ...
                    <div class="pt-4 border-t border-gray-200 dark:border-gray-700">
                        ...
                        >
                            Weekend: ${{ formData.pricing.weekendPrice }} / night
                        </p>
                    </div>
                </div>
            </div>
            ...
            >
                <div class="flex items-start space-x-3">
                    ...
                    >
                        ...
                        I also acknowledge that I will comply with all applicable laws and
                        regulations.
                    </label>
                </div>
            </div>
            ...
            >
                ...
                <ul class="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                    <li class="flex items-start">
                        ...
                        <span>
                            Your listing will be reviewed by our team (usually within 24
                            hours)
                        </span>
                    </li>
                    <li class="flex items-start">
                    ...
                    <li class="flex items-start">
                        ...
                        <span>
                            You'll receive notifications when guests inquire or book
                        </span>
                    </li>
                    <li class="flex items-start">
...
export default {
    ...
    computed: {
        ...mapState("hosting/createAccommodation", ["accommodationDraftId", "accommodationTypes"]),
