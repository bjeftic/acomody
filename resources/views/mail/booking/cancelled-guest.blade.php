    ...
    <div class="body">
        ...
        <div style="margin: 24px 0;">
            ...
            <div class="detail-row">
                ...
                <span class="value" style="color:#16a34a;">{{ strtoupper($booking->currency) }} {{ number_format($booking->refund_amount, 2) }}</span>
            </div>
            @else
            <div class="detail-row">
                <span class="label">Refund</span>
                <span class="value" style="color:#dc2626;">No refund (non-refundable policy)</span>
            </div>
            @endif
        </div>

        <p style="color:#666; font-size:13px;">If you believe this is an error, please contact us at Acomody.</p>
    </div>
    <div class="footer">
