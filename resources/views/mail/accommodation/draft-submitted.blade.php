...
<p>{{ __('mail.draft_submitted.body', ['property' => (function() use ($draft) { $t = json_decode($draft->data, true)['title'] ?? null; return is_array($t) ? ($t['en'] ?? 'your property') : ($t ?: 'your property'); })()]) }}</p>
