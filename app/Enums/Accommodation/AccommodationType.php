...
enum AccommodationType: string
{
    ...
    public function icon(): string
    {
        return match ($this) {
            ...
            self::HOUSE => 'House',
            self::VILLA => 'HouseManor',
            self::CONDO => 'Building',
            self::HOTEL => 'Hotel',
            self::COTTAGE => 'Cabin',
            self::CABIN => 'Cabin',
            self::STUDIO => 'Building',
            self::BED_BREAKFAST => 'Bed',
            self::TOWNHOUSE => 'HouseRoof',
            self::CHALET => 'Cabin',
            self::BUNGALOW => 'Cabin',
            self::GUESTHOUSE => 'House',
            self::LOFT => 'HouseManor',
            self::PENTHOUSE => 'Building',
            self::RESORT => 'Hotel',
            self::GUEST_SUITE => 'House',
            self::HOSTEL => 'Hotel',
            self::FARM_STAY => 'Barn',
            self::BARN => 'Barn',
            self::TREEHOUSE => 'TreePine',
            self::HOUSEBOAT => 'LifeBuoy',
            self::BOAT => 'Sailboat',
            self::CAMPER_RV => 'Van',
            self::TINY_HOUSE => 'House',
            self::GLAMPING => 'Tent',
            self::CASTLE => 'Castle',
            self::YACHT => 'Ship',
            self::DOME => 'Circle',
            ...
            self::CAVE => 'Mountain',
            self::LIGHTHOUSE => 'TowerControl',
            self::WINDMILL => 'Windmill',
            self::EARTH_HOUSE => 'House',
            self::CYCLADIC_HOME => 'Landmark',
            self::TRULLO => 'Cabin',
            self::RIAD => 'HouseRoof',
            self::RYOKAN => 'HouseRoof',
            self::SHEPHERD_HOUSE => 'Cabin',
            self::IGLOO => 'Igloo',
        };
    }
